 ...
 *
 * This is a {@see MessageData} plus the ID of the original message that was
 * edited.
 */
final readonly class MessageEditedBody extends Data
{
    /**
    ...
    public static function fromArray(array $data): static
    {
        return new self(
            ...
            replyTo: isset($data['replyTo']) && is_array($data['replyTo'])
                ? ReplyToMessage::fromArray($data['replyTo'])
                : null,
